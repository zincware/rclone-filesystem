...
| 1-03-01 | 03 | 3 | TEST-04 | unit | `uv run pytest tests/test_path.py -x -q` | No -- Wave 0 | pending |
| 1-03-02 | 03 | 3 | TEST-06 | integration | `uv run pytest tests/ -x -q` | Yes (conftest.py) | pending |
| 1-03-03 | 03 | 3 | TEST-07 | integration | `uv run pytest tests/ -x -q` | Yes (conftest.py) | pending |
| 1-03-04 | 03 | 3 | TEST-09 | integration | `uv run pytest tests/test_protocol.py -x -q` | No -- Wave 0 | pending |
